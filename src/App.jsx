...
function App() {
  ...
  const isOtpValid = () => {
    return otpInput.trim() !== '' && otpInput.length === 4; 
  };
    ...
    if (isLoginFormValid()) {
      try {
        ...
        if (response.data.success) {
          ...
          alert(`Welcome back, ${response.data.data.user.first_name}!`);
        } else {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row">
      <div className="w-full lg:w-1/2 bg-white flex flex-col justify-center px-6 py-12">
        <div className="max-w-md mx-auto w-full">
          <div className="flex items-center mb-8 lg:mb-16 lg:mt-[-100px]">
            <img src={Logo} alt="Logo" className="w-[81px] h-[33px] mr-3" />
          </div>
          ...
          <div className="bg-white p-6 lg:p-10 rounded-[8px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)] border border-[#DDE2E4]">
            {showOtpForm ? (
              <div className="text-center py-8">
                <h2 className="text-[24px] font-bold text-[#1D1D18] mb-6">Enter OTP</h2>
                <p className="text-[#252C32] text-[14px] leading-relaxed mb-8 max-w-sm mx-auto">
                  Enter the OTP sent to <span className="text-[#1D1D18] font-medium">{formData.email}</span>.
                </p>
                {error && (
                ...
                <div className="relative mb-6">
                  {shouldShowLabel('otp') && (
                    <label htmlFor="otp" className="text-[14px] text-[#5B6871] font-medium mb-1 block">OTP</label>
                  )}
                  <input
                    type="text"
                    name="otp"
                    ...
                    className="w-full pl-4 pr-4 py-2 border border-[#DDE2E4] rounded-[6px] text-[14px] placeholder-[#84919A] focus:outline-none focus:border-[#FF8600] transition-colors"
                    maxLength="4"
                  />
                </div>
                <button
                  onClick={handleVerifyOtp}
                  className={`w-[160px] py-2 rounded-[6px] text-[14px] font-medium transition-colors ${
                    isOtpValid()
              ...
              <div className="text-center py-8">
                ...
                <p className="text-[#252C32] text-[14px] leading-relaxed mb-8 max-w-sm mx-auto">
                  ...
                  an OTP: <span className="text-[#1D1D18] font-medium">{otp}</span> to confirm your account. Check your
              ...
              <>
                <h2 className="text-[24px] font-bold text-[#1D1D18] mb-2 text-left">Welcome back</h2>
                <p className="text-[#5B6871] text-[13px] mb-6 text-left">Please sign in to your account</p>
                {error && (
                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-12 py-2 border rounded-[6px] text-[14px] focus:outline-none transition-all duration-200 ${
                      ...
                      {isValidEmail(loginData.email) && loginData.email.trim() !== '' && (
                        <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                          <svg className="w-7 h-7 text-[#119C2B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-12 py-2 border border-[#DDE2E4] rounded-[6px] text-[14px] placeholder-[#84919A] focus:outline-none focus:border-[#FF8600] transition-colors"
                      />
                      <button
                        type="button"
                        onClick={togglePasswordVisibility}
                        className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#84919A] hover:text-[#5B6871] transition-colors"
                      >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <input
                        type="checkbox"
                        id="remember"
                        className="w-4 h-4 text-[#FF8600] border-[#DDE2E4] rounded focus:ring-[#FF8600] focus:ring-2"
                      />
                      <label htmlFor="remember" className="ml-2 text-[14px] text-[#5B6871]">
                        Remember me
                      </label>
                    </div>
                    <button className="text-[14px] text-[#FF8600] hover:text-orange-600 cursor-pointer">
                      Forgot password?
                    </button>
                  </div>
